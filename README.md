...
- 片单 1：TMDB 大陆电视剧、国漫和国内电影混合片单，顺序固定为电视剧 20 部、国漫 20 部、电影 5 部；电视剧只取当前月和上个月的上线内容。
...
所有片单最终都输出 TMDB ID 和类型，封面只下载 TMDB 海报生成。电视剧混合片单每天检查 TMDB 是否有新上线内容；有新剧、新国漫或新电影时按“电视剧 → 国漫 → 电影”重新生成，电视剧大结局检测到 3 天后自动移除。无新上线时保持视频顺序，但仍可生成当天随机的液态玻璃 GIF 封面。综艺片单按当前年度最新普通季排序，当天有正片更新的优先，只有检测到当天有新季上线或正片更新时才重排综艺片单。假面骑士和超级战队使用正剧白名单，只查询 TMDB TV 系列并排除电影、剧场版、特别篇和衍生剧。
