...
4. EMOS 动态片单地址：
   ...
   ```text
   片单 1（TMDB大陆电视剧、国漫与国内电影）：https://cdn.jsdelivr.net/gh/xlmc/emos-watch@main/watch-tmdb-mix.json
...
```text
https://cdn.jsdelivr.net/gh/xlmc/emos-watch@main/watch-tmdb-mix.json
```
...
```text
https://cdn.jsdelivr.net/gh/xlmc/emos-watch@main/cover-tmdb-mix.gif
```
