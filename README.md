...
这个仓库每天北京时间约 07:50、16:50 读取豆瓣当前热门电视剧综合榜，筛选中国大陆、香港、台湾、新加坡、马来西亚剧集，保留华语排名前 50；随后用剧名和年份匹配 TMDB，只把 TMDB 的 `tmdb_id` 写入 `watch.json`，并随机选 3 部 TMDB 海报生成静态 `cover.jpg`。
