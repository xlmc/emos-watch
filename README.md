...
- 片单 2：同时订阅 TMDB、Bangumi（BGM）和 AniList 的今年日本动画，三源合并并统一映射为 TMDB ID，按今年内最新播出动态（最新已开播季首播或最近一集播出时间）从新到旧输出；既包含今年首播的新番，也包含挂在老剧集条目下的今年续作季（如 2026 年开播的芙莉莲第二季、无职转生第三季），并自动合并 TMDB 的重复条目，片单名称永久为“厕纸”。
